...
class DFlashDraftInputV2(SpecInput):
    ...
    def prepare_for_decode(self, batch: ScheduleBatch):
        ...
        batch.seq_lens_cpu = torch.tensor(nxt_kv_lens_cpu, dtype=torch.int64, device="cpu")
    ...
    def merge_batch(self, spec_info: "DFlashDraftInputV2"):
        ...
        self.new_seq_lens = torch.cat([self.new_seq_lens, spec_info.new_seq_lens], dim=0)
